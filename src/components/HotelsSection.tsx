...
const HOTELS = [
  { id: 1, name: "Yurt Camp Kel-Suu", type: "type_yurt", location: "Naryn Oblast", price: 85, rating: 4.9, reviews: 64, image: "https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?w=600&q=80", amenities: ["wifi", "meals", "transfer"] },
  { id: 2, name: "Khan Tengri Lodge", type: "type_lodge", location: "Karakol", price: 145, rating: 4.8, reviews: 41, image: "https://images.unsplash.com/photo-1518732714860-b62714ce0c59?w=600&q=80", amenities: ["wifi", "spa", "transfer"] },
  { id: 3, name: "Issyk-Kul Boutique", type: "type_hotel", location: "Cholpon-Ata", price: 220, rating: 5.0, reviews: 28, image: "https://images.unsplash.com/photo-1571896349842-33c89424de2d?w=600&q=80", amenities: ["wifi", "pool", "meals", "transfer"] },
  { id: 4, name: "Tash-Rabat Guesthouse", type: "type_guesthouse", location: "Naryn", price: 55, rating: 4.7, reviews: 83, image: "https://images.unsplash.com/photo-1566073771259-6a8506099945?w=600&q=80", amenities: ["meals", "transfer"] },
  { id: 5, name: "Son-Kul Sky Camp", type: "type_yurt", location: "Naryn Oblast", price: 95, rating: 4.9, reviews: 52, image: "https://images.unsplash.com/photo-1470770841072-f978cf4d019e?w=600&q=80", amenities: ["meals", "horse riding", "transfer"] },
  { id: 6, name: "Bishkek Luxe Hotel", type: "type_hotel", location: "Bishkek", price: 180, rating: 4.8, reviews: 107, image: "https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?w=600&q=80", amenities: ["wifi", "pool", "spa", "meals"] },
];
          ...
          {HOTELS.map((hotel) => (
            <article key={hotel.id} className="card-hover" style={{ borderRadius: 20, overflow: "hidden", background: "#fff", boxShadow: "0 4px 30px rgba(0,0,0,0.07)", border: "1px solid rgba(0,0,0,0.04)" }}>
              <div style={{ position: "relative", height: 210, overflow: "hidden" }}>
                <img src={hotel.image} alt={hotel.name} style={{ width: "100%", height: "100%", objectFit: "cover", transition: "transform 0.6s" }}
              ...
              <div className="card-content" style={{ padding: "clamp(1.25rem, 4vw, 1.75rem)" }}>
                ...
                <div style={{ display: "flex", gap: "0.5rem", marginBottom: "1.25rem" }}>
                  {hotel.amenities.slice(0, 3).map(a => (
                    <span key={a} style={{ background: "#f0f0f0", color: "#343a40", borderRadius: 8, padding: "0.2rem 0.6rem", fontSize: "0.72rem", fontWeight: 500 }}>{a}</span>
                  ))}
                </div>
